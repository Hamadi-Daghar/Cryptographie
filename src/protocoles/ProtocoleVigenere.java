...
public class ProtocoleVigenere implements Protocole{
    ...
    public void execute() {
        ...
        Algorithme algoVigenere = new AlgorithmeVigenere();
        alice.setAlgorithme(algoVigenere);
        bob.setAlgorithme(algoVigenere);
        
        GenerateurDeCles generateur = new GenerateurDeClesVigenere(5);
